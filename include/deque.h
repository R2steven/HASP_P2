 ...
 */
EXPORT Deque *initDeque(uint16_t queueSize, uint8_t sizeOfData) __fromfile("deque.c");
...
Deque *initDequeCalloc(void *(*myCallocFunc)(size_t,size_t), void (*myFreeFunc)(void*),
                    size_t queueSize, uint8_t sizeOfData) __fromfile("deque.c");

/**
 * perform all necessary operations to destroy the deque and free its memory
 */
EXPORT void destroyDeque(Deque *deque) __fromfile("deque.c");
 ...
 */
bool8_t insertRight(Deque *deque, void *item) __fromfile("deque.c");
 ...
 */
bool8_t removeLeft(Deque *deque, void *ret) __fromfile("deque.c");
 ...
 * @return flag indicating the sucess of the operation
 */
bool8_t removeRight(Deque *deque, void *ret) __fromfile("deque.c");
 ...
 *          BE SAME DATA SIZE AS deque->dataSize
 */
EXPORT bool8_t dqPush(Deque *deque, void *item) __fromfile("deque.c");
 ...
 */
EXPORT bool8_t dqPop(Deque *deque, void *ret) __fromfile("deque.c");
 ...
 *          BE SAME DATA SIZE AS deque->dataSize
 */
EXPORT bool8_t dqEnqueue(Deque *deque, void *item) __fromfile("deque.c");
 ...
 *          MUST BE SAME DATA SIZE AS deque->dataSize
 */
EXPORT bool8_t dqDequeue(Deque *deque, void *ret) __fromfile("deque.c");
 ...
 * @param *deque data structure containing deque data members
 */
EXPORT bool8_t isEmpty(Deque *deque) __fromfile("deque.c");
 ...
 * @param *deque data structure containing deque data members
 */
EXPORT bool8_t isFull(Deque *deque) __fromfile("deque.c");
